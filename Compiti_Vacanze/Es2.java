...
public class Es2{
    public static void main(String[] args){
        ...
        giorno1 = Integer.parseInt(JOptionPane.showInputDialog("Inserisci il giorno in numero della prima data"));
        mese1 = Integer.parseInt(JOptionPane.showInputDialog("Inserisci il mese in numero della prima data"));
        anno1 = Integer.parseInt(JOptionPane.showInputDialog("Inserisci l\'anno della prima data"));
        
        giorno2 = Integer.parseInt(JOptionPane.showInputDialog("Inserisci il giorno in numero della seconda data"));
        mese2 = Integer.parseInt(JOptionPane.showInputDialog("Inserisci il mese in numero della seconda data"));
        ...
        //Se le due date hanno anni di differenza questi vengono convertiti in giorni e aggiunti al risultato finale
